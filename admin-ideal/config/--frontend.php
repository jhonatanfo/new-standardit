<?php
    ...
    define("URL", "http://gomara.tech/");
    //define("URL", "http://localhost:8080/projetos/gomara/");
    ...
    function traducao($valor){   
        ...
        WHERE c.id_pagina = '". $seo[0]['id_pagina'] ."' and b.idioma = '".$sku."'"; 
    ...
    $sqlblocos = "SELECT ideal_blocos.status, ideal_blocos_idioma.chamada, ideal_blocos_idioma.imagem, ideal_blocos.ordem, ideal_blocos_categoria.nome, ideal_paginas.url, ideal_blocos_categoria.id_categoria
    FROM ideal_blocos 
    ...
    WHERE ideal_paginas.url LIKE '%". $url ."%'";
    $totalblocos = 0;
