...
if(isset($_POST['token'])){
    ...
    $res_admin = '<table border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td><img src="https://gomara.tech/img/top.jpg"></td>
      </tr>
      <tr>
      ...
      <tr>
        <td><img src="https://gomara.tech/img/bottom.jpg"></td>
      </tr>
    </table>';
    ...
    $Mailer->setFrom('contato@gomara.tech', utf8_decode('gomara '));

    //$Mailer->From = 'naoresponda@homebrasil.com';
    //$Mailer->FromName = utf8_decode('Planos de Saúde SulAmérica - Contato');
    $Mailer->Subject = utf8_decode("gomara  - Formulário ($servico)");
    ...
    //$Mailer->AddAddress('ola@idealiz.com.br'); // Cópia Oculta
